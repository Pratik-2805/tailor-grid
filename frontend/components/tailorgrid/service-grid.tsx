...
const MVP_SERVICES = [
  {
    ...
    tagline: 'Plain hem, original denim hem, waist shaping & tapering',
  ...
  },
  {
    id: 'shirts',
    title: 'Shirts & Tops',
    tagline: 'Sleeve shortening, side tapering darts & collar adjustments',
    turnaround: '24h / 48h Service',
    price: 'From $22',
    popular: false,
    garmentId: 'shirts',
  ...
  },
  {
    ...
    tagline: 'Complete 2-piece & 3-piece bespoke tailored fitting',
    turnaround: '48h Service',
    price: 'From $68',
    popular: false,
    garmentId: 'suits',
  ...
  },
  {
    ...
    tagline: 'Blouse padding, lehenga shortening & delicate silk fitting',
    turnaround: '48h Service',
    price: 'From $38',
    popular: false,
    garmentId: 'ethnic',
