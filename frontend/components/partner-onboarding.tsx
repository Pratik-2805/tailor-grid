...
import { signUpUser, getStudioUrl, checkEmailExists, loginWithGoogle } from '@/lib/api'
...
export function PartnerOnboarding({ user, onComplete, onSignOut }: PartnerOnboardingProps) {
  ...
  // Step 2 fields (Language & Capacity)
          ...
          try {
            ...
            if (!result.isNewUser && result.user) {
              ...
              if (typeof window !== 'undefined') {
                ...
                window.location.href = getStudioUrl('/', result.token)
                return
              }
              return
            }
    ...
    <div className="min-h-screen bg-white text-[#0F1115] flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          {currentStepNum > 0 && currentStep !== 'hub' && (
            <button
              onClick={() => setCurrentStep(stepsList[currentStepNum - 1])}
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-extrabold text-xl tracking-tight text-[#0F1115]">
              Darzi <span className="text-xs font-semibold uppercase tracking-widest text-[#9E593B] ml-1">Partner</span>
            </span>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-[560px]">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (typeof window !== 'undefined') {
                      ...
                      localStorage.setItem('tg_user_role', 'STUDIO')
                      window.location.href = getStudioUrl('/', 'demo-token')
                    }
                  }}
          ...
          {/* STEP 2: LANGUAGE & CAPACITY PREFERENCE */}
              ...
              <div className="space-y-5 pt-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg bg-gray-100 border-none px-4 py-3.5 text-sm font-medium text-[#0F1115] focus:bg-white focus:ring-2 focus:ring-[#0F1115] outline-none transition-all appearance-none cursor-pointer"
                  >
                    {LANGUAGES.map((lang) => (
